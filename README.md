...
The timezone app can also be imported into your project and run by directly interfacing with the public methods, without needing to star the web service.
